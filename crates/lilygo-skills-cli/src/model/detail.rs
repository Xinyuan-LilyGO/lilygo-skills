...
pub struct GoalStartResult {
    ...
    pub goal_id: String,
    pub dry_run: bool,
    pub planned_commands: Vec<GoalCommandPlan>,
    pub required_permissions: Vec<String>,
    pub planned_artifacts: Vec<String>,
    pub ran_commands: Vec<GoalCommandEvidence>,
    pub blocked_permissions: Vec<String>,
    pub writes: Vec<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub evidence_path: Option<String>,
    pub highest_verification_level: String,
    pub hardware_verified: bool,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub repeated_failure_count: Option<u32>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct GoalCommandEvidence {
    pub recipe_id: String,
    pub step_id: String,
    pub command: String,
    pub status: String,
...
pub struct GoalEvidence {
    ...
    pub highest_verification_level: String,
    pub hardware_verified: bool,
    pub commands: Vec<GoalCommandEvidence>,
    pub artifacts: Vec<String>,
